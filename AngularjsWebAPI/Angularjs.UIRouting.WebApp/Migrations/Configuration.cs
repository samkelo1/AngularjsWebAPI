    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DataContext>
    {
        ...
        protected override void Seed(DataContext context)
        {
            var Users = new List<User>{
                new User { UserId = 1, FullName = "Alejandra Camino", Address = "Gran Vía, 1", City = "Madrid", ZipCode = "28001", Country = "Spain", Image = "/UserImages/image-1.jpg" },
                ...
                new User { UserId = 3, FullName = "Ana Trujillo", Address = "Avda. de la Constitución 2222", City = "México D.F.", ZipCode = "05021", Country = "Mexico", Image = "/UserImages/image-3.jpg" },
                new User { UserId = 4, FullName = "Anabela Domingues", Address = "Av. Inês de Castro, 414", City = "Sao Paulo", ZipCode = "05634-030", Country = "Brazil", Image = "/UserImages/image-4.jpg" },
                new User { UserId = 5, FullName = "André Fonseca", Address = "Av. Brasil, 442", City = "Campinas", ZipCode = "04876-786", Country = "Brazil", Image = "/UserImages/image-5.jpg" },
                ...
                new User { UserId = 8, FullName = "Antonio Moreno", Address = "Mataderos  2312", City = "México D.F.", ZipCode = "05023", Country = "Mexico", Image = "/UserImages/image-8.jpg" },
                new User { UserId = 9, FullName = "Aria Cruz", Address = "Rua Orós, 92", City = "Sao Paulo", ZipCode = "05442-030", Country = "Brazil", Image = "/UserImages/image-9.jpg" },
                ...
                new User { UserId = 13, FullName = "Carlos González", Address = "Carrera 52 con Ave. Bolívar #65-98 Llano Largo", City = "Barquisimeto", ZipCode = "3508", Country = "Venezuela", Image = "/UserImages/image-1.jpg" },
                new User { UserId = 14, FullName = "Carlos Hernández", Address = "Carrera 22 con Ave. Carlos Soublette #8-35", City = "San Cristóbal", ZipCode = "5022", Country = "Venezuela", Image = "/UserImages/image-7.jpg" },
                ...
                new User { UserId = 16, FullName = "Christina Berglund", Address = "Berguvsvägen  8", City = "Luleå", ZipCode = "S-958 22", Country = "Sweden", Image = "/UserImages/image-8.jpg" },
                ...
                new User { UserId = 20, FullName = "Eduardo Saavedra", Address = "Rambla de Cataluña, 23", City = "Barcelona", ZipCode = "08022", Country = "Spain", Image = "/UserImages/image-10.jpg" },
                ...
                new User { UserId = 25, FullName = "Francisco Chang", Address = "Sierras de Granada 9993", City = "México D.F.", ZipCode = "05022", Country = "Mexico", Image = "/UserImages/image-5.jpg" },
                new User { UserId = 26, FullName = "Frédérique Citeaux", Address = "24, place Kléber", City = "Strasbourg", ZipCode = "67000", Country = "France", Image = "/UserImages/image-2.jpg" },
                ...
                new User { UserId = 29, FullName = "Guillermo Fernández", Address = "Calle Dr. Jorge Cash 321", City = "México D.F.", ZipCode = "05033", Country = "Mexico", Image = "/UserImages/image-1.jpg" },
                ...
                new User { UserId = 34, FullName = "Henriette Pfalzheim", Address = "Mehrheimerstr. 369", City = "Köln", ZipCode = "50739", Country = "Germany", Image = "/UserImages/image-2.jpg" },
                new User { UserId = 35, FullName = "Horst Kloss", Address = "Taucherstraße 10", City = "Cunewalde", ZipCode = "01307", Country = "Germany", Image = "/UserImages/image-7.jpg" },
                ...
                new User { UserId = 37, FullName = "Isabel de Castro", Address = "Estrada da saúde n. 58", City = "Lisboa", ZipCode = "1756", Country = "Portugal", Image = "/UserImages/image-1.jpg" },
                ...
                new User { UserId = 41, FullName = "Jean Fresnière", Address = "43 rue St. Laurent", City = "Montréal", ZipCode = "H1J 1C3", Country = "Canada", Image = "/UserImages/image-1.jpg" },
                ...
                new User { UserId = 45, FullName = "José Pedro Freyre", Address = "C/ Romero, 33", City = "Sevilla", ZipCode = "41101", Country = "Spain", Image = "/UserImages/image-9.jpg" },
                new User { UserId = 46, FullName = "Jytte Petersen", Address = "Vinbæltet 34", City = "Kobenhavn", ZipCode = "1734", Country = "Denmark", Image = "/UserImages/image-2.jpg" },
                new User { UserId = 47, FullName = "Karin Josephs", Address = "Luisenstr. 48", City = "Münster", ZipCode = "44087", Country = "Germany", Image = "/UserImages/image-1.jpg" },
                ...
                new User { UserId = 53, FullName = "Lúcia Carvalho", Address = "Alameda dos Canàrios, 891", City = "Sao Paulo", ZipCode = "05487-020", Country = "Brazil", Image = "/UserImages/image-1.jpg" },
                new User { UserId = 54, FullName = "Manuel Pereira", Address = "5ª Ave. Los Palos Grandes", City = "Caracas", ZipCode = "1081", Country = "Venezuela", Image = "/UserImages/image-9.jpg" },
                ...
                new User { UserId = 56, FullName = "Maria Larsson", Address = "Åkergatan 24", City = "Bräcke", ZipCode = "S-844 67", Country = "Sweden", Image = "/UserImages/image-8.jpg" },
                ...
                new User { UserId = 58, FullName = "Mario Pontes", Address = "Rua do Paço, 67", City = "Rio de Janeiro", ZipCode = "05454-876", Country = "Brazil", Image = "/UserImages/image-2.jpg" },
                new User { UserId = 59, FullName = "Martín Sommer", Address = "C/ Araquil, 67", City = "Madrid", ZipCode = "28023", Country = "Spain", Image = "/UserImages/image-1.jpg" },
                new User { UserId = 60, FullName = "Martine Rancé", Address = "184, chaussée de Tournai", City = "Lille", ZipCode = "59000", Country = "France", Image = "/UserImages/image-10.jpg" },
                ...
                new User { UserId = 64, FullName = "Michael Holz", Address = "Grenzacherweg 237", City = "Genève", ZipCode = "1203", Country = "Switzerland", Image = "/UserImages/image-8.jpg" },
                new User { UserId = 65, FullName = "Miguel Angel Paolino", Address = "Avda. Azteca 123", City = "México D.F.", ZipCode = "05033", Country = "Mexico", Image = "/UserImages/image-5.jpg" },
                new User { UserId = 66, FullName = "Palle Ibsen", Address = "Smagsloget 45", City = "Århus", ZipCode = "8200", Country = "Denmark", Image = "/UserImages/image-6.jpg" },
                ...
                new User { UserId = 73, FullName = "Pedro Afonso", Address = "Av. dos Lusíadas, 23", City = "Sao Paulo", ZipCode = "05432-043", Country = "Brazil", Image = "/UserImages/image-1.jpg" },
                new User { UserId = 74, FullName = "Peter Franken", Address = "Berliner Platz 43", City = "München", ZipCode = "80805", Country = "Germany", Image = "/UserImages/image-2.jpg" },
                ...
                new User { UserId = 79, FullName = "Rita Müller", Address = "Adenauerallee 900", City = "Stuttgart", ZipCode = "70563", Country = "Germany", Image = "/UserImages/image-1.jpg" },
                ...
                new User { UserId = 81, FullName = "Sergio Gutiérrez", Address = "Av. del Libertador 900", City = "Buenos Aires", ZipCode = "1010", Country = "Argentina", Image = "/UserImages/image-9.jpg" },
            ...
            var contacts = new List<Contact>
            {
                ...
                new Contact  {ContactId =34, UserId =5,Mobile="", WorkPhone ="555-8787", HomePhone="", WorkEmail="AndréFonseca@gmail.com",PersonalEmail="someWorkEmail@hotmail.com"},
                new Contact  {ContactId =35, UserId =5,Mobile="", WorkPhone ="(0544) 60323", HomePhone="(0544) 60603", WorkEmail="AndréFonseca@gmail.com",PersonalEmail="someWorkEmail@hotmail.com"},
